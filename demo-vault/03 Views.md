...
- **Sample view**
  - a plain `ItemView` that renders a heading.
- **Sample svelte view**
  - the same idea implemented with a [Svelte](https://svelte.dev/) component.
- **Sample react view**
  - implemented with a [React](https://react.dev/) component.
