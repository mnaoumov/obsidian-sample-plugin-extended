...
- **Otherwise**, download `sample-plugin-extended-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-sample-plugin-extended/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `sample-plugin-extended-demo-vault-<version>` folder it unzips into.
